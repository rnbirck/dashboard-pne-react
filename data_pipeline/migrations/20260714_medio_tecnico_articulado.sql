-- Curated contract for the Meta 12.a enrolment proxy.
-- Required source components remain nullable: missing is not zero.
CREATE OR REPLACE VIEW pne_matriculas_medio_tecnico_articulado AS

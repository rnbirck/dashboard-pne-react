...
REASON_MESSAGES = {
    ...
    "rreo_mapping_pending": "O mapeamento do RREO ainda não está visível na interface P5-C1.",
    "reconciliation_pending_source": "A reconciliação constitucional permanece oculta até a P5-C2.",
